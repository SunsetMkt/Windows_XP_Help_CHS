...
<IMG alt=目录 hspace=0 src="cont.gif" border=0 >
</SPAN>
<SPAN STYLE="LEFT: -4px; POSITION: relative; TOP: 4px">
<A id="index" href="Index.asp" hidefocus><IMG alt=索引 hspace=0 src="NoIndex.gif" border=0 ></A>
</SPAN>

<SPAN STYLE="LEFT: -8px; POSITION: relative; TOP: 4px">
<A id="search" href="Search.asp" hidefocus><IMG alt=搜索 src="nosearch.gif" border=0 ></A>
</SPAN>

<table border="0" width="262" height="31" cellspacing=2 bgcolor="white" bordercolor="white">
<TR><TD align="right">
<A id="printBtn" onclick=TOCPrint_Click() href="#Ptoc" hidefocus><IMG align="baseline" alt="打印某个主题或节点" src ="print.gif" border=0 ></a><a name="Ptoc"></a>
<A id="synch" onclick=TOCSynch_Click() href="#Stoc" hidefocus><IMG align="baseline" alt="使目录与目录窗格同步" src ="synch.gif" border=0 ></a><a name="Stoc"></a>
...
<div align="right" ><A target="main" href="/iishelp/iis/htm/core/NavigationHelp.htm" >帮助</A></div>
</BODY>
</HTML>