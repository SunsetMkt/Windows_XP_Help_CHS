...
<H2><A NAME="_conditional_operators"></A><SUP> <% If Request("DontFrame")<>1 Then Response.Redirect "/iissamples/sdk/asp/docs/SampFram.asp?ovfile=/iishelp/iis/htm/asp/asps5l9v.asp&srcfile=Simple/Conditional" %></SUP>Conditional Operators</H2>
